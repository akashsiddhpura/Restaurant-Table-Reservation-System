...
class AcceptedHotelListPage extends StatefulWidget {
  @override
  _AcceptedHotelListPageState createState() => _AcceptedHotelListPageState();
}

class _AcceptedHotelListPageState extends State<AcceptedHotelListPage> {
            ...
            Expanded(
              child: Container(
                child: StreamBuilder<QuerySnapshot>(
                  stream: MyApp().controller.ownerAcceptedReference.snapshots(),
                  builder:
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.asset(approvalImage,
                                          fit: BoxFit.cover),
                                    ),
                                  ),
                                  Container(
